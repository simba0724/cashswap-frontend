...
import useGetPublicIfoV1Data from 'views/Presales/hooks/v1/useGetPublicIfoData'
import useGetWalletIfoV1Data from 'views/Presales/hooks/v1/useGetWalletIfoData'
import { Ifo } from 'config/constants/types'
import IfoFoldableCard from './IfoFoldableCardCurrent'
